...
zip lambda/bundle/$1-python.zip lambda/python/handler.py src/wombats/lib/python/wombat_lib.py
...
zip lambda/bundle/$1-javascript.zip lambda/javascript/index.js src/wombats/lib/javascript/wombat_lib.js
...
ln -f src/wombats/lib/clojure/wombat_lib.clj lambda/clojure/src/wombat_lib.clj
cd lambda/clojure
lein uberjar
