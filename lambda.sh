...
zip lambda/bundle/$1-python.zip lambda/python/handler.py lib/wombat_lib.py
...
zip lambda/bundle/$1-javascript.zip lambda/javascript/index.js lib/wombat_lib.js
