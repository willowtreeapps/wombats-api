(ns wombats.router
  (:require [compojure.core :refer [GET POST DELETE context defroutes]]
            ...
            [wombats.middleware :refer [wrap-middleware]]
            [wombats.controllers.games :as games]
            [wombats.controllers.players :as players]
            [wombats.controllers.simulator :as simulator]
            [wombats.controllers.authenication :as auth]
            [wombats.views.index :refer [index]]
            [wombats.controllers.socket :as ws]))
