...
(def db-username (System/getenv "WOMBATS_MONGOD_USER_NAME"))
(def db-password (System/getenv "WOMBATS_MONGOD_USER_PW"))
(def db-host (System/getenv "WOMBATS_MONGOD_HOST_LIST"))
...
(def connection-uri (if is-production?
                      (str "mongodb://" db-username ":" db-password "@" db-host "/wombats")
                      "mongodb://127.0.0.1/wombats"))
